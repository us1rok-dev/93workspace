...
do
    ...
    do
        ...
        do -- Combat
            local Subpages = {
                ["Fling"] = Pages["Combat"]:SubPage({
                    Name = "Fling", 
                    Icon = "111386589037485", 
                    Columns = 2
                }),
                ["ACSBypass"] = Pages["Combat"]:SubPage({
                    Name = "ACS", 
            ...
            do
                local GeneralSection = Subpages["Fling"]:Section({Name = "Spin", Icon = "103174889897193", Side = 1})
				local GeneralSection3 = Subpages["Fling"]:Section({Name = "Legit", Icon = "103174889897193", Side = 1})
				local GeneralSection4 = Subpages["Fling"]:Section({Name = "Target", Icon = "103174889897193", Side = 1})
                local GeneralSection2 = Subpages["ACSBypass"]:Section({Name = "general", Icon = "103174889897193", Side = 1})
                ...
                do
					...
					local Toggle = GeneralSection2:Toggle({
                        Name = "enabled",
                        Flag = "enabled",
                        Default = false,
                        Callback = function(Value)
					...
					local Toggle = GeneralSection3:Toggle({
                        Name = "enabled",
                        Flag = "enabled",
                        Default = false,
                        Callback = function(Value)
					...
					local Toggle = GeneralSection4:Toggle({
                        Name = "enabled",
                        Flag = "enabled",
                        Default = false,
                        Callback = function(Value)
